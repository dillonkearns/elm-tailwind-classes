...
`;
    ...
    // Intercept CSS requests - rewrite to our wrapper CSS
    configureServer(server) {
      ...
      server.middlewares.use((req, res, next) => {
        ...
        if (!req.url.endsWith('/' + cssFileName) && req.url !== '/' + cssFileName) {
          return next();
        }

        // Rewrite to our wrapper CSS
        const newUrl = '/' + generateDir + '/styles.css';
